 ...
 * This class is executed everytime SpringBoot starts.
 * Currently using it to load data into the H2 Database, since it's memory DB, everytime the
 * application restarts, the DB is brand new.
 *
 * TODO:: check how to have this type of functionality in DEV, but then disable it for PRODUCTION, for example.
 */
@Component
public class DivisionLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private Logger log = Logger.getLogger(DivisionLoader.class);
